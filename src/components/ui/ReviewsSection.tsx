  ...
  return (
    <section className="py-12 bg-cafe-cream">
      <div className="cafe-container">
        <h2 className="text-3xl font-medium text-cafe-rose mb-10 text-center">Reviews</h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-cafe-lavender/10"
            >
              ...
              <p className="mb-3 sm:mb-4 italic text-gray-700 text-sm sm:text-base">{review.text}</p>
